...
# ------------------------------------------------------------------
# Extended Kalman Filter adapted from github.com/psas/filters
# Dynamic model adapted from
# http://iaac.technion.ac.il/workshops/2010/KFhandouts/LectKF8.pdf
# ------------------------------------------------------------------
# Author: Chris Andre (chrisandre01@gmail.com)
#===================================================================
"""
We will not use this for now. Nothing to see here.
"""
from numpy import *
...
class RocketDragModel(process_model):
